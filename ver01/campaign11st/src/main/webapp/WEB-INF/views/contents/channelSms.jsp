...
<script language="JavaScript">
	...
	function fn_save() {
		...
		$("#SMS_DISP_TIME").attr("disabled",false);
		
		jQuery.ajax({
			url           : '${staticPATH }/setContentsChannelSms.do',
			dataType      : "JSON",
			scriptCharset : "UTF-8",
			type          : "POST",
	        data          : $("#form").serialize(),
...
//         }
	...
	function fn_getShortUrl(){
		...
		jQuery.ajax({
			url           : '${staticPATH }/contentsChannelSmsShortUrl.do',
			dataType      : "JSON",
			scriptCharset : "UTF-8",
			type          : "POST",
	        data          : $("#form").serialize(),
	...
	function fn_pre_view(){
		...
		jQuery.ajax({
			url           : '${staticPATH}/contentsChannelSmsPreview.do',
			dataType      : "JSON",
			scriptCharset : "UTF-8",
			type          : "POST",
	        data          : $("#form").serialize(),
