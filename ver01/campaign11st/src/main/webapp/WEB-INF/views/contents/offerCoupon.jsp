...
<script language="JavaScript">
  ...
  function fn_save() {
    ...
    jQuery.ajax({
      url           : '${staticPATH }/setContentsOfferCu.do',
      dataType      : "JSON",
      scriptCharset : "UTF-8",
      type          : "POST",
          data          : $("#form").serialize(),
  ...
  function fn_search(){
    ...
    jQuery.ajax({
      url           : '${staticPATH }/contents/getOfferTmplCupnInfo.do',
      dataType      : "JSON",
      scriptCharset : "UTF-8",
      type          : "POST",
      data          : $("#form").serialize(),
...
<input type="hidden" id="ISS_CN_END_DT2" name="ISS_CN_END_DT2" value="" />
 -->
<input type="hidden" id="CELL_PACKAGE_SK" name="CELL_PACKAGE_SK" value="${bo.cell_package_sk}" />
  ...
  <div class="col-lg-12" id="table">
    <table class="table table-striped table-hover table-condensed table-bordered" width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td class="tbtd_content"><span id="SP_ISS_CN_BGN_DT"></span><span id="SP_ISS_CN_END_DT"></span></td>
        <td class="info">유효기간</td>
        <td class="tbtd_content"><span id="SP_EFTV_BGN_DT"></span><span id="SP_EFTV_END_DT"></span><span id="SP_CUPN_EFTV_PRD_BASI_NM"></span></td>
      </tr>
      <tr>
