    ...
    beforeSend:function(){
      ...
      success: function(result, option) {
        if(option=="success"){
          ...
          if(result.batchDtCheck == "ERROR"){
            ...
            return "ERROR";
          }else if(result.batchDtCheck == "first"){
            alert("정상처리 되었습니다.");
            closeWindowByMask();
          }else{
      ...
      // Schedule 값세팅
              ...
              $.each(list, function(key){
                ...
                if(nvl(data.cellname,'') != old_cellname){
                  txt += "<td rowspan="+data.cellrow+">"+data.cellname+"</td>";
                }
                ...
                old_cellname = nvl(data.cellname,'');
...
function fn_searchSchedule() {
  ...
  jQuery.ajax({
    ...
    async: true,
    type          : "POST",
        data          : { CampaignId     : $("#scheduleCampaignId").val(),
						   ...
						   <td class="tbtd_content" colspan="3">
						      <div style="display:inline;" id="cmpgnDtType1" style="display:none;">
							     <span id = "CAMP_BGN_DT1"></span>
						 	     <span id = "CAMP_BGN_DT2"></span>
						   	          시
							     <span id = "CAMP_BGN_DT3"></span>
							           분
							     ~
							     <span id = "CAMP_END_DT1"></span>
							     <span id = "CAMP_END_DT2"></span>
							            시
							     <span id = "CAMP_END_DT3"></span>
								  분						
							  </div>
               ...
               <div role="tabpanel" class="tab-pane fade" id="offer" aria-labelledby="profile-tab">
                  <!-- <div class="col-md-12" style="text-align:right;margin-bottom:10px;">
                     <button type="button" class="btn btn-warning btn-sm" id="offerEdit">
                          <i class="fa fa-pencil" aria-hidden="true"></i> 편 집 </button>
                  </div> -->
                  <div id="offerList" >
