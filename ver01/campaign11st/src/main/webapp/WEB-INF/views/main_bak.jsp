                                ...
                                <ul class="chat">
                                    <li class="left clearfix">
                                        <span class="chat-img pull-left">
                                            <img src="${staticURL }/assets/img/1.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                    ...
                                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="${staticURL }/assets/img/2.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                    ...
                                    <li class="left clearfix">
                                        <span class="chat-img pull-left">
                                            <img src="${staticURL }/assets/img/3.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <strong class="primary-font"> Jack Sparrow </strong>
                                    ...
                                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="${staticURL }/assets/img/4.png" alt="User Avatar" class="img-circle" />
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
                                                <small class=" text-muted">
